	...
	public static void loadAllVideoMedia(Context mContext) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					cursor= MediaStore.Video.query(App.applicationContext.getContentResolver(), MediaStore.Video.Media.EXTERNAL_CONTENT_URI, projectionPhotos);
					  if (cursor != null) {
...
//												App.applicationContext.getContentResolver(),imageId,
